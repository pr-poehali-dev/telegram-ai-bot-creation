...
const DEMO_RESPONSES = [
  "✨ Отличный вопрос! Давайте разберёмся вместе. Это действительно интересная тема, которая требует внимательного рассмотрения с нескольких сторон.",
  "🧠 Понял вас! Вот что я думаю по этому поводу: важно учитывать контекст и конкретные детали вашей ситуации.",
  "💡 Интересная мысль! Позвольте предложить несколько вариантов подхода к этому вопросу.",
  "🎯 Хороший вопрос! Ключевое здесь — это правильно определить приоритеты и действовать последовательно.",
  "🚀 Давайте разберём это подробнее. Мне кажется, здесь есть несколько важных аспектов, которые стоит обсудить.",
  "💬 Понимаю вашу мысль. Это действительно важный момент, и я готов помочь вам найти лучшее решение.",
];
